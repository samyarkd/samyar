...
export const MobileMenu = () => {
  ...
  return <>
    <button onClick={() => setOpen(!open)} className='sm:hidden ms-auto w-6'>
      {
        open ?
          <svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg"><path fill={theme.isDark ? "#fff" : "#000000"} d="M195.2 195.2a64 64 0 0 1 90.496 0L512 421.504 738.304 195.2a64 64 0 0 1 90.496 90.496L602.496 512 828.8 738.304a64 64 0 0 1-90.496 90.496L512 602.496 285.696 828.8a64 64 0 0 1-90.496-90.496L421.504 512 195.2 285.696a64 64 0 0 1 0-90.496z" /></svg>
          :
          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M4 18L20 18" stroke={theme.isDark ? "#fff" : "#000000"} strokeWidth="2" strokeLinecap="round" />
            <path d="M4 12L20 12" stroke={theme.isDark ? "#fff" : "#000000"} strokeWidth="2" strokeLinecap="round" />
            <path d="M4 6L20 6" stroke={theme.isDark ? "#fff" : "#000000"} strokeWidth="2" strokeLinecap="round" />
          </svg>
      }
    </button>
