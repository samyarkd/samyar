...
const Header = () => {
  return (
    <>
      <div className="fixed top-0 h-[65px] sm:h-[68px] w-full z-50 backdrop-blur border-b border-black/25 dark:border-white/25 dark:backdrop-brightness-50 border-solid">
